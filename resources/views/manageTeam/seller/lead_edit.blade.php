...
<div class="container mt-4">
    <a  href="{{ route('seller.dashboard') }}" class="btn btn-outline-secondary btn-retroceder">
        &#8592; Back
    </a>
    ...
    <div class="card shadow-lg p-4">
        ...
        <form action="{{ route('seller.leads.update', $lead->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
